  ...
  return (
    <BeamsBackground>
      <div className="container mx-auto px-4 py-8">
        <header className="relative flex h-[350px] md:h-[450px] w-full flex-col items-center justify-center overflow-hidden rounded-3xl border mb-16 shadow-2xl group">
          ...
          <div className="relative z-20 text-center px-6 w-full max-w-2xl">
            ...
            <div className="mt-10 relative pointer-events-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
              <div className="relative group/search">
                <Input 
                  placeholder="Search for lab coats, textbooks, notes..." 
                  className="pl-12 h-14 text-lg bg-background/90 backdrop-blur-2xl border-white/20 text-foreground ring-offset-primary focus:ring-primary shadow-2xl transition-all duration-300 group-hover/search:bg-background"
                  value={searchQuery}
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="h-1 flex-1 bg-primary/20 ml-6 rounded-full hidden sm:block" />
          </div>
          ...
          {filteredItems.length > 0 ? (
            ...
            <div className="text-center py-24 bg-card/10 backdrop-blur-md rounded-3xl border border-dashed border-white/20">
              <Frown className="mx-auto h-20 w-20 text-white opacity-20" />
              <h3 className="mt-6 text-3xl font-bold text-white">No Results Found</h3>
