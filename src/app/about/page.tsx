  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <header className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-6xl font-bold font-headline mt-6">About AlgoSwap</h1>
      ...
      <section className="mb-16">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                AlgoSwap started as a simple idea in a dorm room: what if there was a safe and easy way for students to buy and sell goods exclusively within their campus community? Frustrated by the unreliability of public forums and the hassle of dealing with strangers, we set out to build a platform that prioritizes trust, convenience, and affordability.
                </p>
                <p className="text-muted-foreground text-lg">
                Today, AlgoSwap is a thriving marketplace connecting thousands of students, helping them save money, reduce waste, and build a stronger campus community. From textbooks and lab coats to furniture and electronics, AlgoSwap is the go-to platform for all student needs.
                </p>
              </div>
      ...
      <section>
        <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 max-w-xl mx-auto">
                The passionate individuals behind AlgoSwap, dedicated to serving the student community.
            </p>
        </div>
